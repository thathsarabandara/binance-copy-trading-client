...
export const Login: React.FC = () => {
  ...
  const authImage = (
    <div className="hidden md:block lg:w-full lg:h-full object-cover rounded-lg shadow-lg">
      <img src="/assets/Follower/auth/login.png" alt="LK Trader" className="object-cover w-full h-full" />
    </div>
  );
  ...
  return (
    <AuthLayout image={authImage}>
      <div className="mb-8 text-center">
        <h1 className="text-3xl font-bold text-gray-900 mb-2 ">Welcome Back Follower!</h1>
        <p className="text-gray-600">Sign in to your follower account to continue</p>
      </div>
      ...
      <div className="mt-6 pt-6 border-t border-yellow-100">
        <p className="text-center text-gray-600">
          ...
          <Link to="/follower/auth/register" className="text-yellow-600 hover:text-yellow-700 font-semibold">
            Sign up
          </Link>
        </p>
      </div>
