...
export const Login: React.FC = () => {
  ...
  return (
    <AuthLayout image={authImage}>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2 text-center">Welcome Back, Trader</h1>
        <p className="text-gray-600 text-center text-center">Sign in to your account to continue for trading activities</p>
      ...
      <div className="mt-6 pt-6 border-t border-yellow-100">
        <p className="text-center text-gray-600">
          ...
          <Link to="/trader/auth/register" className="text-yellow-600 hover:text-yellow-700 font-semibold">
            Sign up
          </Link>
        </p>
      </div>
